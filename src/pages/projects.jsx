    ...
    <div className="flex flex-col min-h-screen">
      <main className="flex-grow max-w-5xl mx-auto p-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 p-6 bg-gray-100 border-l-4 border-tigerGold rounded shadow flex flex-col gap-4">
            <h2 className="text-2xl font-semibold mb-2">{projects[0].title}</h2>
            ...
            {projects[0].media && (
              projects[0].isVideo ? (
                ...
                <img src={projects[0].media} alt={projects[0].title} className="w-full h-48 object-cover rounded" />
              )
            )}

            <p className="mb-2">{projects[0].description}</p>
            <span className="text-tealBlue font-medium">{projects[0].stack}</span>
