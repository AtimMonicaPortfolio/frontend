...
import Resume from "../assets/atim_monica_resume.pdf";
    ...
    <div className="flex flex-col min-h-screen">
      ...
      >
        ...
        >
          ...
          <a
          href={Resume}
          download="Atim-Monica-Resume.pdf"
          className="group flex items-center justify-center gap-2  
            bg-tealBlue text-white px-6 py-3 rounded-lg shadow 
            hover:bg-deepBlue transition w-full sm:w-auto 
        ...
        >
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="w-6 h-6 transform transition-all duration-300 group-hover:-translate-y-1"
          >
            <path
              strokeLinecap="round"
          ...
          <span className="transform transition-all duration-300 group-hover:-translate-y-1">
            Download Resume
          </span>
        </a>
